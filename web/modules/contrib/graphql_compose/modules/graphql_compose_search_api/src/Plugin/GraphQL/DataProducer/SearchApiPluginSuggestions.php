...
use Drupal\graphql_compose_search_api\SearchApiPluginSuggestionsHelper;
use Drupal\graphql_compose_search_api\SuggestionConnection;
 ...
 *
 * @DataProducer(
 *   id = "graphql_compose_search_api_suggestions",
