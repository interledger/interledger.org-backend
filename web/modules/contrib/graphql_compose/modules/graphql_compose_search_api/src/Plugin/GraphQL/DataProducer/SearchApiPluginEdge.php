...
namespace Drupal\graphql_compose_search_api\Plugin\GraphQL\DataProducer;
...
use Drupal\graphql_compose_search_api\EntityConnection;
use Drupal\graphql_compose_search_api\SearchApiPluginQueryHelper;
 ...
 *
 * @DataProducer(
 *   id = "graphql_compose_search_api_edge",
...
class SearchApiPluginEdge extends DataProducerPluginBase implements ContainerFactoryPluginInterface
{
   ...
   */
  public function resolve(?int $first, ?string $after, ?int $last, ?string $before, bool $reverse, string $sortKey, string $keywords, RefinableCacheableDependencyInterface $metadata)
  {
