...
namespace Drupal\graphql_compose_extra_edges;
...
class EntityConnection implements ConnectionInterface {
   ...
   *
   * @param \Drupal\graphql_compose_extra_edges\ConnectionQueryHelperInterface $queryHelper
   ...
   *
   * @param \Drupal\graphql_compose_extra_edges\Wrappers\EdgeInterface[] $edges
   *   Edges to check access on.
   *
   * @return \Drupal\graphql_compose_extra_edges\Wrappers\EdgeInterface[]
   *   Filtered edge nodes.
   */
   ...
   */
  protected function buildFilterConditions($query, array $filter)
  {
