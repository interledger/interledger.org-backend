 ...
 *
 * @DataProducer(
 *   id = "responsive_image_derivatives",
 ...
 * )
 */
class ResponsiveImageDerivatives extends DataProducerPluginBase implements ContainerFactoryPluginInterface {
  ...
  public function resolve(?FileInterface $entity = NULL, string|array $value, RefinableCacheableDependencyInterface $metadata): ?array {
    ...
    /** @var Drupal\graphql_compose_extra_responsive_image_style\Plugin\GraphQL\DataProducer\ResponsiveImageDerivative $plugin */
    $plugin = $this->dataProducerPluginManager->createInstance('responsive_image_derivative');
